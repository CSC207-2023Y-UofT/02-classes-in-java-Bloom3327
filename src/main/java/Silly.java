...
public class Silly implements Comparable<Silly>{
     ...
     */
    /** Creating a new Silly Object.
     *
     * @param carModel this is the model of the car.
     * @param carType this is the type of car.
     */
    public Silly(String carModel, String carType) {
        this.name = carModel + "" + carType;
    }
    ...
    public int compareTo(Silly other) {
        ...
        int otherLen = other.name.length();
